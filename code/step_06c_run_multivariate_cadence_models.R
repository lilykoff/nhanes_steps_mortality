...
together = list(c(step_vars[1], peak1_vars[1]),
                ...
                c(step_vars[3], peak1_vars[3]),
                c(step_vars[4], peak1_vars[4]),
                c(step_vars[5], peak1_vars[5]),
                c(step_vars[6], peak1_vars[6]),
                c(step_vars[7], peak1_vars[7]))

together2 = list(c(step_vars[1], peak30_vars[1]),
                 c(step_vars[2], peak30_vars[2]),
                 c(step_vars[3], peak30_vars[3]),
                 c(step_vars[4], peak30_vars[4]),
                 c(step_vars[5], peak30_vars[5]),
                 c(step_vars[6], peak30_vars[6]),
                 c(step_vars[7], peak30_vars[7]))



all_list = c(add_vars_list, step_peak_list, step_peak30_list, together, together2)
